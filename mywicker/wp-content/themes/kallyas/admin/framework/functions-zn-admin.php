...
$accordions = array(
	'Style 1' => '[accordion title="" style="default-style" collapsed="false"] Content [/accordion]', 
	'Style 2' => '[accordion title="" style="style2" collapsed="false"] Content [/accordion]', 
	'Style 3' => '[accordion title="" style="style3" collapsed="false"] Content [/accordion]', 
	);
...
function of_load_only() {
	...
	wp_enqueue_script('zn-admin-scripts', ADMIN_MASTER_ADMIN_DIR . '/js/zn-admin-scripts.js', array( 'wp-color-picker', 'jquery' ));
