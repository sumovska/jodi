		...
		$output .= '<div class="zn_backup_sep"></div>';
			...
			if ( count( $theme_backups ) > 0 ){
				...
				foreach ($theme_backups as $key => $value) {
					...
					$output .= '<li><a class="zn_restore_option" data-backup="'.$option_name.'" href="#">'. $option_name.'</a><span data-backup="'.$option_name.'" class="zn_question zn_delete_backup zn_delete">x</span><li>';
				}
				$output .= '</ul>';
